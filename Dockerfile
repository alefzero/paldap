...
RUN mkdir -p ${PALDAP_HOME} ${PALDAP_CONFIG} ${PALDAP_CONFIG_LDIF} ${PALDAP_DATA}

ADD run.sh ${PALDAP_HOME}
ADD config.sh ${PALDAP_HOME}

RUN chown -R ${PALDAP_USER}:${PALDAP_USER} ${PALDAP_HOME} ${PALDAP_CONFIG} ${PALDAP_CONFIG_LDIF} ${PALDAP_DATA}
